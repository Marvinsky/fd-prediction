...
//Speed Progress
    ...
    //the threshold is initialized with twice the initial heuristic value and is update in the update_jump_value
	...
	cout<<"b_initial_v: h_value = "<<h_value<<"\n";
...
SearchStatus EagerSearch::step() {
	...
	GlobalState global_state_2 = g_state_registry->lookup_state(succ_state.get_id());
...
void EagerSearch::generateSSCCReport() {
	...
	output<<"bitcollector.size() = "<<bitcollector.size()<<"\n";
