...
//********************speed progress************************
      ...
      string directoryDomain = "mkdir /home/marvin/marvin/speed/"+heuristica+"/reportspeed/"+dominio+"/speed";
      if (system(directoryDomain.c_str())) {
         cout<<"Directory created successfully."<<endl;
      }
      
      string nBL = "/home/marvin/marvin/speed/"+heuristica+"/reportspeed/"+dominio+"/speed/"+tarefa; 
...
SearchStatus SpeedProgress::step() {
...
void SpeedProgress::generateExpandedReport() {
	...
	string directoryDomain = "mkdir /home/marvin/marvin/speed/"+heuristica+"/reportspeed/"+dominio;
	if (system(directoryDomain.c_str())) {
		cout<<"Directory created successfully."<<endl;
	}


	string nBL = "/home/marvin/marvin/speed/"+heuristica+"/reportspeed/"+dominio+"/"+tarefa;
	ofstream outputFile;
